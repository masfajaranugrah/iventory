                            ...
                            @foreach ($returBarangs as $item)
                                <tr class="centerText">
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{route('retur-barang-disetujui-admin', $item->id)}}">
                                            @csrf
                                            <button type="submit" class="btn btn-success btn-lg" style="width:150px;">Disetujui</button>
                                        </form>
                                        <form method="POST" action="{{route('retur-barang-ditolak-admin', $item->id)}}">
                                            @csrf
